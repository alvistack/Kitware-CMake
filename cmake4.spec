...
set -ex && \
    ...
    ../bootstrap \
        ...
        -DCMAKE_C_FLAGS:STRING="-O2 -DNDEBUG" \
...
%package -n cmake4-gui
Summary: CMake graphical user interface
Requires: cmake4 = %{epoch}:%{version}-%{release}
Requires: hicolor-icon-theme
Requires: shared-mime-info

%description -n cmake4-gui
...
Requires: cmake4 = %{epoch}:%{version}-%{release}
Conflicts: cmake < %{epoch}:%{version}-%{release}
...
%package -n cmake-gui
Summary: Dummy pacakge
Requires: cmake4-gui = %{epoch}:%{version}-%{release}
Conflicts: cmake-gui < %{epoch}:%{version}-%{release}
